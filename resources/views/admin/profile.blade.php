        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 mt-4">
                    <div class="card">
                        <div class="card-header text-light text-center fw-bold" style="background-color: #1e9bd8">
                            {{ __('Dashboard') }}</div>
                            ...
                            <div class="card text-center mt-3">
                                ...
                                <div class="card-body text-dark">
                                    ...
                                    <div class="d-flex justify-content-center">
                                            ...
                                            <a class="row g-0 text-decoration-none" href="{{ route('admin.items.index') }}">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text"><small class="text-body-secondary">List of all
                                                                your
                                                                items.</small></p>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="mb-3 mx-2 card card-custom p-3 w-25">
                                            <a class="row g-0 text-decoration-none"
